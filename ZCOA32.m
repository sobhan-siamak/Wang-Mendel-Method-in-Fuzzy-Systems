function [ yhat ] = ZCOA32( num11,num12,num13,num21,num22,mutx11,mutx12,mutx13,mutx21,mutx22,RuleBaseFinal,stepy,Fcenty )
...
w5=min(mutx13,mutx21);
w6=min(mutx13,mutx22);
...
y5=RuleBaseFinal(num13,num21);
y6=RuleBaseFinal(num13,num22);
